        ...
        <div className="relative z-10 container mx-auto px-4 py-16 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto">
              Descubra como preparar o doce mais desejado do momento e transformar essa delícia em uma fonte de renda real, mesmo que você nunca tenha feito um doce na vida!
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center mb-12">
              <img 
                ...
                className="w-80 h-80 object-cover rounded-2xl shadow-2xl pulse-glow"
              />
            ...
            <div className="countdown-timer rounded-xl p-4 inline-block text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <Card key={index} className="text-center p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                <CardContent className="p-0">
                  <div className="text-4xl mb-4">{benefit.icon}</div>
                  <h3 className="text-xl font-bold mb-3 text-strawberry">{benefit.title}</h3>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-strawberry-light rounded-3xl p-12 mb-12">
              ...
              <div className="countdown-timer rounded-xl p-6 inline-block text-white mb-8">
                <p className="text-xl font-bold mb-4">⏳ Restam apenas 23 vagas – acesso imediato!</p>
                <div className="flex items-center justify-center gap-2">
                  <Clock className="w-6 h-6" />
                  <span className="text-lg">Últimas vagas com 79% de desconto</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="flex items-center justify-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">7 dias - sem burocracia</p>
                </div>
              </div>
              <div className="flex items-center justify-center gap-3">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <p className="text-lg mt-8 opacity-90">
              📱 Suporte por WhatsApp | 🏆 Certificado de conclusão | ♾️ Acesso vitalício
            </p>
          </div>
        </div>
      </section>
